...
namespace nah
{
	...
	static inline int randomInt(void) { return rand();	}
	//random int between 0 and RAND_MAX, inclusiveness determined by boolean
	static inline int randomInt(bool inclusive)
	...
	static inline int randomInt(int min, int max, bool inclusive)
		;//put implementation here
	...
	static inline float randomFloat(bool inclusive)
	...
	static inline float randomFloat(float min, float max, bool inclusive)
